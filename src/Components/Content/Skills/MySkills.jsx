...
const BootstrapIcon = props => <Icon component={BootstrapSVG} {...props} />;
const GitIcon = props => <Icon component={GitSVG} {...props} />;
const JSicon = props => <Icon component={JSsvg} {...props} />;
const JQueryIcon = props => <Icon component={JQuerySVG} {...props} />;
const NodeIcon = props => <Icon component={NodeSVG} {...props} />;
const ReactIcon = props => <Icon component={ReactSVG} {...props} />;

const CSStext = <span>CSS3</span>;
const HTMLtext = <span>HTML5</span>;
const BootstrapText = <span>Bootstrap CSS Framework</span>;
const GitText = <span>Git CLI</span>;
const JStext = <span>JavaScript</span>;
const JQueryText = <span>JQuery</span>;
const NodeText = <span>Node.js</span>;
const ReactText = <span>React JavaScript Library</span>;
const AntdText = <span>Ant Design UI Library</span>;
const SketchText = <span>Sketch Design Toolkit</span>;
    ...
    return (
        <div className="skillLinks">
            <Col style={{
                ...
                <Row style={{marginBottom: '1vh'}}><h2>MySkills:</h2></Row>
                <Row style={{
                    display: 'flex',
                    justifyContent: 'space-between'
                }}>
                    <Tooltip placement="top" title={JStext}><JSicon style={{fontSize: '38px'}} /></Tooltip>
                    <Tooltip placement="top" title={NodeText}><NodeIcon style={{fontSize: '38px'}} /></Tooltip> 
                    <Tooltip placement="top" title={HTMLtext}><HTMLicon style={{fontSize: '38px', marginRight: '12px'}} /></Tooltip>
                    <Tooltip placement="top" title={AntdText}><AntDesignOutlined style={{fontSize: '38px', marginLeft: '8px', color: '#9296A0'}} /></Tooltip>
                    <Tooltip placement="top" title={SketchText}><SketchOutlined style={{fontSize: '38px', marginLeft: '38px', marginRight: '19px', color: '#9296A0'}} /></Tooltip>
                </Row>
                <br />
                <Row style={{
                    display: 'flex',
                    ...
                    <Tooltip placement="bottom" title={ReactText}><ReactIcon style={{fontSize: '38px'}} /></Tooltip>
                    <Tooltip placement="bottom" title={JQueryText}><JQueryIcon style={{fontSize: '38px'}} /></Tooltip>
                    <Tooltip placement="bottom" title={CSStext}><CSSicon style={{fontSize: '38px'}} /></Tooltip>
                    <Tooltip placement="bottom" title={BootstrapText}><BootstrapIcon style={{fontSize: '38px'}} /></Tooltip>
                    <Tooltip placement="bottom" title={GitText}><GitIcon style={{fontSize: '38px'}} /></Tooltip>
                </Row>
            </Col>

            {/* <Row>
                <Col>
                    <Tooltip placement="right" title={JStext}><JSicon /></Tooltip>
                </Col>
                <Col>
                    <Tooltip placement="right" title={ReactText}><ReactIcon /></Tooltip>
                </Col>
            </Row>
            <br />
            <Row>
                <Col>
                    <Tooltip placement="right" title={NodeText}><NodeIcon /></Tooltip> 
                </Col>
                <Col>
                    <Tooltip placement="right" title={JQueryText}><JQueryIcon /></Tooltip>
                </Col>
            </Row>
            <br />
            <Row>
                <Col>
                    <Tooltip placement="right" title={HTMLtext}><HTMLicon /></Tooltip>
                </Col>
                <Col>
                    <Tooltip placement="right" title={CSStext}><CSSicon /></Tooltip>
                </Col>
            </Row>
            <br />
            <Row>
                <Col>
                    <Tooltip placement="right" title={AntdText}><AntDesignOutlined /></Tooltip>
                </Col>
                <Col>
                    <Tooltip placement="right" title={BootstrapText}><BootstrapIcon /></Tooltip>
                </Col>
            </Row>
            <br />
            <Row>
                <Col>
                    <Tooltip placement="right" title={SketchText}><SketchOutlined /></Tooltip>
                </Col>
                <Col>
                    <Tooltip placement="right" title={GitText}><GitIcon /></Tooltip>
                </Col>
            </Row> */}
        </div>
    )
